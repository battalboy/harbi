"""
EXPERIMENTAL: Tumbet Timestamp Format Debug Script

This is a DEBUG VERSION of event_create_tumbet.py
Purpose: Check the format of stunix timestamp from Tumbet/SportWide API
